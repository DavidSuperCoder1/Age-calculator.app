...
function checkDay(){
    ...
    document.querySelector('#day_input').style.border ="1px solid hsl(0, 0%, 86%)";
    ...
    if(date.length ===0){     // input for date is empty
        ...
        document.querySelector('#day').style.color='hsl(0, 100%, 67%';//red
        document.querySelector('#day_input').style.border ="1px solid hsl(0, 100%, 67%";//red
...
function checkMonth(){   //when any input and function is called will do these things
    ...
    document.querySelector('#month_input').style.border ="1px solid hsl(0, 0%, 86%)";
   ...
   if(month.length===0){          // input for month is empty
        ...
        document.querySelector('#month').style.color='hsl(0, 100%, 67%';//red
        document.querySelector('#month_input').style.border ="1px solid hsl(0, 100%, 67%";//red
...
function checkYear(){     //when any input and function is called will do these things
        ...
        document.querySelector('#year_input').style.border ="1px solid hsl(0, 0%, 86%)";
       ...
       if(year.length===0){                // input for year is empty 
            ...
            document.querySelector('#year').style.color='hsl(0, 100%, 67%)';//red
            document.querySelector('#year_input').style.border ="1px solid hsl(0, 100%, 67%)";//red
...
function calculateAge(){        //when any input and function is called will do these things
    ...
    if(date.length !=0 && month.length != 0 && year.length!=0 ){
    ...
    }else if(date.length ==0 && month.length ==0 && year.length==0 ){
        checkDay();
        checkMonth();
        checkYear();
        ...
        checkDay();
        checkMonth();
    }else if(date.length ==0 && year.length==0 ){
        checkDay();
        checkYear();
